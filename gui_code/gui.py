...
class FarmBeatsApp:
    ...
    def optionFrameSetUp(self):
        ...
        tempButton = Button(self.optionFrame, image=tempImg, command = self.tempButtonAction, borderwidth=0) 
        ...
        humidityButton = Button(self.optionFrame, image=humidityImg, command = self.humidityButtonAction, borderwidth=0) 
        ...
        waterButton = Button(self.optionFrame, image=waterImg, command = self.waterButtonAction, borderwidth=0) 
        ...
        aiCameraButton = Button(self.optionFrame, image=aiCameraImg, command = self.aiCameraButtonAction, borderwidth=0) 
        ...
        sysVisualButton = Button(self.optionFrame, image=systemImg, command = self.sysVisualButtonAction, borderwidth=0) 
